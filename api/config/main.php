...
$params =  array(
	...
	'db.name' => 'xe247',
	'db.connectionString' => 'mysql:host=localhost;dbname=xe247',
	'db.username' => 'namviet',
	'db.password' => 'Namviet@2013',
		);
//require_once($apiConfigDir . DIRECTORY_SEPARATOR . 'params.php');
...
return CMap::mergeArray(
	array(
		...
		'components' => array(
			...
			'db' => array(
// 				'connectionString' => 'mysql:host=localhost;dbname=xe247',
				'connectionString' => $params['db.connectionString'],
				'username' => 'namviet',
				'password' => 'Namviet@2013',
