...
$this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'subscriber-transaction-grid-extend-info',
...
// 		'id',
		array(
				'name'=>'create_date',
				'htmlOptions'=>array('class'=>'html', 'rows'=>6,'height'=>'30px', 'width'=>'180px', 'style' => 'max-height:50px;'),
		),
		array(
				'name'=>'service_id',
...
// 		'subscriber_id',
		array(
				...
				'htmlOptions'=>array('class'=>'html', 'rows'=>1,'height'=>'30px', 'width'=>'60px', 'style' => 'max-height:50px;'),
		),
		'channel_type',
		array(
				'name'=>'purchase_type',
