...
$criteriaExtend = array(
		'condition'=>'subscriber_id='.$model->id . " and purchase_type = 2",
		'order'=>'id desc',
);
...
if(Yii::app()->user->hasFlash('response')) $activeTab = 4;
else $activeTab=0;
...
//     	'Nhắn tin'=>$this->renderPartial('sms_service',array('model'=>$model),true),
    ),
    'options'=>array(
        'collapsible'=>true,
        'selected'=>$activeTab,
