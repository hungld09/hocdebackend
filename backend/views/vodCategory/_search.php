...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'display_name_ascii'); ?>
		<?php echo $form->textField($model,'display_name_ascii',array('size'=>60,'maxlength'=>200)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'description_ascii',array('size'=>60,'maxlength'=>1000)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'vod_attribute_set_id'); ?>
		<?php echo $form->textField($model,'vod_attribute_set_id'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'child_count'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'image_url'); ?>
		<?php echo $form->textField($model,'image_url',array('size'=>60,'maxlength'=>1000)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'tags'); ?>
		<?php echo $form->textField($model,'tags',array('size'=>60,'maxlength'=>1000)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'tags_ascii'); ?>
		<?php echo $form->textField($model,'tags_ascii',array('size'=>60,'maxlength'=>1000)); ?>
	</div>
