        ...
        <div id="description_input" style="display:none">
            <?php
                $form=$this->beginWidget('CActiveForm', array(
                        'id'=>'vod-category-form-for-description',
...
<script>
    function sendDescription() {
                    ...
                    $.ajax({
  url:"<?php echo Yii::app()->createUrl('admin/vodCategory/updateDescription') ?>",
 data: {description:$('#VodCategory_description').val(), id: "<?php echo $model->id?>" },
 type: 'POST',
