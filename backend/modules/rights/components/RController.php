...
* @since 0.6
*/
define('DEPLOY_STATUS', 0); // == 1 : ban deploy -> ko hien thi cac fan tasks, operation, permission
class RController extends CController
{
	...
	*/
	...
	{
// 		file_put_contents('log.txt', print_r($filterChain));
	...
	*/
    ...
    protected function beforeAction($action){
        $this->menu2 = User::getArrayMenu2(Yii::app()->user->id);
