...
class RAuthorizer extends CApplicationComponent
{
	...
	* @param mixed $data additional data associated with the item.
	*/
	public function updateAuthItem($oldName, $name, $description='', $bizRule=null, $data=null, $level=0)
	{
	...
	//Chau added
	public function get1stAuthItem($types=null, $userId=null, CAuthItem $parent=null, $sort=true, $exclude=array())
	{
		// We have none or a single type.
		if( $types!==(array)$types )
		{
	...
	*/
	public function getSuperusers()
	{
		...
		$superUsers = Users::model()->findAllByAttributes(array("superuser" => 1, "status" => 1));
