...
<?php $form=$this->beginWidget('CActiveForm'); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'level', array('maxlength'=>255, 'class'=>'text-field')); ?>
		<?php echo $form->error($model, 'level'); ?>
		<p class="hint"><?php echo Rights::t('core', 'Admin - 3, Service admin - 2, Something else - 1, Supporter - 0.'); ?></p>
	</div>
