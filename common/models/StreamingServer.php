 ...
 *
 * The followings are the available columns in table 'streaming_server':
 * @property integer $id
 * @property string $url
...
class StreamingServer extends CActiveRecord
{
	 ...
	 * @return StreamingServer the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
				...
				array('id, url,priority, status, description', 'safe', 'on'=>'search'),
		);
	}
