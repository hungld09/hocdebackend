...
/**
 * This is the model class for table "view_token".
 *
 * The followings are the available columns in table 'view_token':
 * @property string $id
 ...
 */
class ViewToken extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ViewToken the static model class
	 */
