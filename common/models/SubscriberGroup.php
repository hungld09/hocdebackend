...
class SubscriberGroup extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('status_log, create_date, modify_date', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, code_name, display_name, description, status, status_log, create_date, create_user_id, modify_date, modify_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'subscriberGroupMappings' => array(self::HAS_MANY, 'SubscriberGroupMapping', 'subscriber_group_id'),
		);
	}
